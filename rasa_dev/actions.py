...
class ActionCertaindaysPlan(Action):
    ...
    async def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        data is {recipe_text} and my child age is {age} and height {height} and weight is {weight} and lactose suggestion {lactose_intolerant} and 
         each day with breakfast , lunch , dinner and snacks without repetitive recipe from this data and give details 
        """
...
class ActionCertaindaysFallbackQuestion(Action):
    ...
    async def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        {certain_days_question} days ,give details of recipe name , description , incredients ,nutrients present in recipe for each day(breakfast ,lunch , snacks , dinner) .
        """
